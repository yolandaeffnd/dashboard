...
$this->title = 'Peminat PMB Pascasarjana';
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="callout callout-info">
                <p>
                    Halaman ini akan menampilkan data peminat Penerimaan Mahasiswa Baru Pascasarjana (PMB Pascasarjana) tiap program studi. 
                </p>
            </div>
            <div class="audit-form">
                ...
                if (empty($dataCategories) && empty($dataSeries)) {
                    ...
                    echo Form::widget([
                        ...
                        'columns' => 2,
                        'attributes' => [
                            'thnAkt' => ['label' => 'Tahun Masuk', 'type' => Form::INPUT_WIDGET, 'widgetClass' => Select2::className(), 'options' => [
