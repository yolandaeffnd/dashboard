...
<div class="box" style="margin-top: -15px;margin-bottom: 10px;">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="<?php echo Url::to(['pmb-diploma']); ?>" class="fa fa-reply btn btn-default btn-flat"> Kembali</a>
        </div>
    </div>
</div>
<div class="row" style="padding-right: 10px;">
    <div class="col-sm-12" style="padding-bottom: 10px;">
        <?php
        echo $this->render('_pmbDiplomaGrafikCol', [
            'model' => $model,
            'dataCategories' => $dataCategories,
            'dataSeries' => $dataSeries,
        ]);
        
        echo $this->render('_pmbDiplomaTabel', [
            'model' => $model,
            'dataTabel' => $dataTabel,
        ]);
        ?>
