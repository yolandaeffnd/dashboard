    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr style="background: #dff0d8">
                ...
                <th rowspan="2" style="width: 150px;text-align: center;vertical-align: middle;">Pilihan 2</th>
                <th rowspan="2" style="width: 150px;text-align: center;vertical-align: middle;">Pilihan 3</th>
                <th rowspan="2" style="width: 150px;text-align: center;vertical-align: middle;">Jumlah</th>
            </tr>
        </thead>
        <tbody>
            <?php
