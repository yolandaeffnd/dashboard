...
use Yii;
use app\modules\akademik\models\Peminat;
...
class PeminatController extends Controller {
    ...
    public function behaviors() {
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    User::userAccessRoles2('ctrlAkademikPeminat'),
                        [
                        'allow' => true,
                        'actions' => [
                        ],
    ...
    public function actionPmbDiploma() {
        $conn = new DAO();
        $model = new Peminat();
        //Ref Angkatan
        $qRefAkt = "SELECT * FROM ref_angkatan a "
                . "JOIN peminat_diploma b ON b.peminatTahun=a.angkatan "
                . "GROUP BY angkatan "
                . "ORDER BY angkatan DESC";
        $refAkt = $conn->QueryAll($qRefAkt, []);
        //Program Studi
        $qRefProdi = "SELECT * FROM ref_prodi_nasional WHERE prodiJenjang='D3'";
...
//                ],
    ...
    public function actionPmbIntake() {
        $conn = new DAO();
        $model = new Peminat();
        //Ref Angkatan
        $qRefAkt = "SELECT * FROM ref_angkatan a "
                . "JOIN peminat_intake b ON b.peminatTahun=a.angkatan "
                . "GROUP BY angkatan "
                . "ORDER BY angkatan DESC";
        $refAkt = $conn->QueryAll($qRefAkt, []);
        //Program Studi
        ...
        if ($model->load(Yii::$app->request->post())) {
            $qData = "SELECT 
                    CONCAT(b.`prodiJenjang`,' - ',b.`prodiNama`)AS namaProdi,
                    a.`peminatPil1`
                    FROM `peminat_intake` a
                    JOIN `ref_prodi_nasional` b on b.`prodiKode`=a.`peminatProdiKode`
                    WHERE a.`peminatTahun`=:tahun
                    GROUP BY a.`peminatProdiKode`,a.`peminatTahun`
                    ORDER BY peminatPil1 DESC";
            $rsData = $conn->QueryAll($qData, [
                ':tahun' => $model->thnAkt
            ]);
            $data = [];
            foreach ($rsData as $val) {
                $data[] = [$val['namaProdi'], (int) $val['peminatPil1']];
                if (!in_array($val['namaProdi'], $dataCategories)) {
                    $dataCategories[] = $val['namaProdi'];
                }
            }
    ...
    public function actionPmbPasca() {
        $conn = new DAO();
        $model = new Peminat();
        //Ref Angkatan
        $qRefAkt = "SELECT * FROM ref_angkatan a "
                . "JOIN peminat_pasca b ON b.peminatTahun=a.angkatan "
                . "GROUP BY angkatan "
                . "ORDER BY angkatan DESC";
        $refAkt = $conn->QueryAll($qRefAkt, []);
        //Program Studi
    ...
    public function actionSnmptn() {
        $conn = new DAO();
        $model = new Peminat();
        //Ref Angkatan
        $qRefAkt = "SELECT * FROM ref_angkatan a "
                . "JOIN peminat_snmptn b ON b.peminatTahun=a.angkatan "
                . "GROUP BY angkatan "
                . "ORDER BY angkatan DESC";
        $refAkt = $conn->QueryAll($qRefAkt, []);
        //Program Studi
        ...
        if ($model->load(Yii::$app->request->post())) {
            $qData = "SELECT 
                    CONCAT(b.`prodiJenjang`,' - ',b.`prodiNama`)AS namaProdi,
                    a.`peminatPt1Pil1`,a.`peminatPt1Pil2`,a.`peminatPt2Pil1`,a.`peminatPt2Pil2`,
                    SUM(a.`peminatPt1Pil1` + a.`peminatPt1Pil2`)as ptn1,
                    SUM(a.`peminatPt2Pil1` + a.`peminatPt2Pil2`)as ptn2,
                    SUM(a.`peminatPt1Pil1` + a.`peminatPt1Pil2` + a.`peminatPt2Pil1` + a.`peminatPt2Pil2`)as jml 
                    FROM `peminat_snmptn` a
                    JOIN `ref_prodi_nasional` b on b.`prodiKode`=a.`peminatProdiKode`
                    WHERE a.`peminatTahun`=:tahun
                    GROUP BY a.`peminatProdiKode`,a.`peminatTahun`
                    ORDER BY jml DESC";
            ...
            foreach ($rsData as $val) {
                if ($n <= 10) {
                    $tot[] = $val['ptn1'] + $val['ptn2'];
                    $data['PTN1'][] = [$val['namaProdi'], (int) $val['ptn1']];
                    $data['PTN2'][] = [$val['namaProdi'], (int) $val['ptn2']];
                    if (!in_array($val['namaProdi'], $dataCategories)) {
                        $dataCategories[] = $val['namaProdi'];
                    }
                }
    ...
    public function actionSbmptn() {
        $conn = new DAO();
        $model = new Peminat();
        //Ref Angkatan
        $qRefAkt = "SELECT * FROM ref_angkatan a "
                . "JOIN peminat_sbmptn b ON b.peminatTahun=a.angkatan "
                . "GROUP BY angkatan "
                . "ORDER BY angkatan DESC";
        $refAkt = $conn->QueryAll($qRefAkt, []);
        //Program Studi
    ...
    public function actionSmmptn() {
        $conn = new DAO();
        $model = new Peminat();
        //Ref Angkatan
        $qRefAkt = "SELECT * FROM ref_angkatan a "
                . "JOIN peminat_smmptn b ON b.peminatTahun=a.angkatan "
                . "GROUP BY angkatan "
                . "ORDER BY angkatan DESC";
        $refAkt = $conn->QueryAll($qRefAkt, []);
        //Program Studi
        ...
        if ($model->load(Yii::$app->request->post())) {
            $qData = "SELECT 
                    CONCAT(b.`prodiJenjang`,' - ',b.`prodiNama`)AS namaProdi,
                    a.`peminatPil1`,a.`peminatPil2`,a.`peminatPil3`,
                    a.`peminatPil4`,a.`peminatPil5`,a.`peminatPil6`,a.`peminatPil7`,
                    SUM(a.`peminatPil1` + a.`peminatPil2` + a.`peminatPil3`+a.`peminatPil4`+a.`peminatPil5`+a.`peminatPil6`+a.`peminatPil7`)as jml 
                    FROM `peminat_smmptn` a
                    JOIN `ref_prodi_nasional` b on b.`prodiKode`=a.`peminatProdiKode`
                    WHERE a.`peminatTahun`=:tahun
                    GROUP BY a.`peminatProdiKode`,a.`peminatTahun`
                    ORDER BY jml DESC";
