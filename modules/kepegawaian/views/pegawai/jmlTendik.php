...
$this->title = 'Jumlah Tenaga Kependidikan';
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-warning" style="margin-bottom: 5px;">
                        <div class="panel-heading" style="padding-top:8px;padding-bottom:8px;">
                            <h5 style="margin: 0px;"><i>Berdasarkan Jenis Fungsional</i></h5>
                        </div>
                        <div class="panel-body center" style="padding-bottom: 0px;padding-right: 30px">
                            <div class="col-md-8">
                                <?php
                                echo Highcharts::widget([
                                    ...
                                    'options' => [
                                        ...
                                        'xAxis' => [
                                            ...
                                            'categories' => $data['BY_JENIS_FUNGSIONAL']['kategori']
                                        ],
                                        'yAxis' => [
                                            'min' => 0,
                                            'title' => [
                                        ...
                                        'series' => $data['BY_JENIS_FUNGSIONAL']['kolom'],
                                        'dataLabels' => [
                                            'enabled' => true,
                                            'rotation' => -90,
                                            'color' => '#FFFFFF',
                                ...
                                echo Highcharts::widget([
                                    ...
                                    'options' => [
                                        ...
                                        'xAxis' => [
                                            ...
                                            'categories' => $data['BY_JENIS_FUNGSIONAL_NON']['kategori']
                                        ],
                                        'yAxis' => [
                                            'min' => 0,
                                            'title' => [
                                        ...
                                        'series' => $data['BY_JENIS_FUNGSIONAL_NON']['kolom'],
                                        'dataLabels' => [
                                            'enabled' => true,
                                            'rotation' => -90,
                                            'color' => '#FFFFFF',
                ...
                <div class="col-md-12">
                    <div class="panel panel-warning" style="margin-bottom: 5px;">
                        <div class="panel-heading" style="padding-top:8px;padding-bottom:8px;">
                            <h5 style="margin: 0px;"><i>Berdasarkan Fungsional</i></h5>
                        </div>
