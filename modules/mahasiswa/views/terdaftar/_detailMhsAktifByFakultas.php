    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            foreach ($dataTabel as $val) {
                ...
                <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $val['FAK_NAMA']; ?></td>
                    <?php
                    foreach ($dataTabel_akt as $valAkt) {
                        ?>
                        <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkel('by-fakultas', $valAkt['AKT'], $val['FAK_KODE'], 'L')); ?></td>
                        <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkel('by-fakultas', $valAkt['AKT'], $val['FAK_KODE'], 'P')); ?></td>
                        <?php
                    }
                    ?>
        ...
        <footer>
            <tr>
                ...
                foreach ($dataTabel_akt as $valAkt) {
                    ?>
                <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkel('by-fakultas', $valAkt['AKT'], null, 'L')); ?></td>
                    <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkel('by-fakultas', $valAkt['AKT'], null, 'P')); ?></td>
                    <?php
                }
                ?>
