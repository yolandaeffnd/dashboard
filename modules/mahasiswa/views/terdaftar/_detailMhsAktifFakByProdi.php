    ...
    <table class="table table-bordered table-striped">
            ...
            foreach ($dataTabel as $val) {
                ...
                <tr>
                    ...
                    foreach ($dataTabel_akt as $valAkt) {
                        ?>
                        <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkelFak('by-prodi', $valAkt['AKT'], $fakId, $val['PRODI_KODE'], 'L')); ?></td>
                        <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkelFak('by-prodi', $valAkt['AKT'], $fakId, $val['PRODI_KODE'], 'P')); ?></td>
                        <?php
                    }
                    ?>
        ...
        <footer>
            <tr>
                ...
                foreach ($dataTabel_akt as $valAkt) {
                    ?>
                    <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkelFak('by-prodi', $valAkt['AKT'], $fakId, null, 'L')); ?></td>
                    <td style="text-align: center;"><?php echo $terbilang->setNumber($Terdaftar->getJmlPerJenkelFak('by-prodi', $valAkt['AKT'], $fakId, null, 'P')); ?></td>
                    <?php
                }
                ?>
