    ...
    public function actionGetAktifFakDetail($act, $params) {
        ...
        if (\Yii::$app->request->isAjax) {
			...
			mhs.mhsAngkatan AS AKT,
                        ...
                        WHERE mhs1.mhsAngkatan IN(" . $param['akt'] . ") 
                        AND mhs1.mhsAngkatan<=YEAR(NOW())-7
                        AND mhs1.fakId=:fak
                        GROUP BY mhs1.mhsAngkatan,mhs1.fakId
                        ORDER BY mhs1.mhsAngkatan DESC 
                        LIMIT 1)
                        UNION
                        (SELECT * 
                        ...
                        WHERE mhs2.mhsAngkatan IN(" . $param['akt'] . ") 
                        AND mhs2.mhsAngkatan>YEAR(NOW())-7
                        AND mhs2.fakId=:fak
                        GROUP BY mhs2.mhsAngkatan,mhs2.fakId)
                        )AS mhs
                        ORDER BY mhs.mhsAngkatan ASC";
                $dataTabel_akt = $conn->QueryAll($qAkt, [
                    ':fak'=>$param['fak']
