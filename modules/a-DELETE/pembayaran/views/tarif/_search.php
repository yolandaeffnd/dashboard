...
/* @var $model app\modules\referensi\models\RefInstrukturSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="ref-bank-search" style="margin-bottom: -15px;">
    <div class="box">
        ...
        <div class="box-body">
            ...
            //Jenis Biaya
            $dataJenisBiaya = RefJenisBiaya::find()->all();
            
            $form = ActiveForm::begin([
                        'id' => 'frm-cari-jenis-biaya',
            ...
            echo Form::widget([
                ...
                'attributes' => [
                    ...
                    'tarifJnsBiayaId' => ['type' => Form::INPUT_WIDGET, 'widgetClass' => Select2::className(), 'options' => [
                            'data' => ArrayHelper::map($dataJenisBiaya, 'jnsBiayaId', 'jnsBiayaNama'),
                            'size' => Select2:: MEDIUM,
                            'options' => [
