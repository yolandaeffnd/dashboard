...
echo DetailView::widget([
    ...
    'attributes' => [
        ...
        'memberDsnNidn',
            [
            'attribute' => 'memberDsnProdiId',
            'value' => empty($model->memberDsnProdiId) ? '-' : RefProdi::findOne(['prodiSiaId' => $model->memberDsnProdiId])->prodiNama
        ],
            [
            'attribute' => 'memberDsnFakId',
            'value' => empty($model->memberDsnFakId) ? '-' : RefFakultas::findOne($model->memberDsnFakId)->fakNama
        ],
        'memberEmail',
        'memberTelp',
            [
