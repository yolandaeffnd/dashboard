...
<div style="border: solid 1px #cccccc;border-radius: 2px;width:800px;">
    ...
    <div style="padding: 10px;font-size:14px;text-align: justify;">
        ...
        Silahkan gunakan <b><i>Email</i></b> sebagai <b><i>Username</i></b> untuk login di <?php echo Html::a('http://simpb.lc.unand.ac.id/backoffice', 'http://simpb.lc.unand.ac.id/backoffice', ['target' => '_blank']); ?>.<br/>
