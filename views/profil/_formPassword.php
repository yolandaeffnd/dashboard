...
<div class="app-user-form">
    ...
    echo Form::widget([
        ...
        'columns' => 2,
        'attributes' => [
            'passwordAppNew' => ['type' => Form::INPUT_PASSWORD, 'options' => ['placeholder' => 'Password Baru']],
            'passwordAppNewUlang' => ['type' => Form::INPUT_PASSWORD, 'options' => ['placeholder' => 'Ulangi Password Baru']],
            'passwordAppOld' => ['type' => Form::INPUT_PASSWORD, 'options' => ['placeholder' => 'Password Lama']],
        ]
    ]);
    echo Form::widget([
        'model' => $model,
